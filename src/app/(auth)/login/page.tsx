        ...
        <div className="relative flex flex-col justify-between h-full p-12">
          ...
          <div>
            <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight mb-6">
              Platforma dla ambitnych <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500">
                Inwestorów
              </span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              Zrezygnuj z chaotycznych arkuszy kalkulacyjnych. Trzymaj koszty w ryzach, weryfikuj postępy z gotowymi checklistami i przechowuj wszystkie umowy i paragony w jednym miejscu.
            </p>
          </div>
          ...
          <div className="flex gap-4 items-center">
            ...
            <p className="text-sm text-muted-foreground">Dołącz do pionierów cyfrowej budowy.</p>
          </div>
        </div>
      </div>
